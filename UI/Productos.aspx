				...
				<div class="col-12 col-sm-6">
                   ...
                   <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource13" runat="server" ConnectionString="<%$ ConnectionStrings:BDautorepuestoConnectionString %>" SelectCommand="SELECT [ID_Medida], [Medida] FROM [Medida] ORDER BY Medida ASC"></asp:SqlDataSource>
                        </div>
						</div>
                     </div>
					                </div>
