...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                       <div class="row">
                           ...
                           <div class="col-xs-2">
                               <asp:DropDownList ID="DropDownList3" CssClass="form-control select2" runat="server" DataSourceID="SqlDataSource2" DataTextField="Categoria" DataValueField="ID_SubCategoria" AutoPostBack="true" OnSelectedIndexChanged="DropDownList3_SelectedIndexChanged"></asp:DropDownList>
    ...
    <asp:GridView ID="GridView3" runat="server" CssClass="table table-responsive" AutoGenerateColumns="False" DataKeyNames="ID_DevProPro" DataSourceID="SqlDataSource4" OnSelectedIndexChanged="GridView3_SelectedIndexChanged" >
        <Columns>

            
            <asp:BoundField DataField="ID_DevProPro" HeaderText="ID" ReadOnly="True" SortExpression="ID_DevProPro" InsertVisible="False" />
            ...
            <asp:TemplateField ShowHeader="False">
                <ItemTemplate>
                    <asp:LinkButton runat="server" Text="Entregar" CommandName="Select" CausesValidation="False"  ID="LinkButton10"></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
